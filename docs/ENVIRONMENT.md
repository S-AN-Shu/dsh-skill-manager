...
- DSH Desktop v0.3.8 remains the only runtime/adapter target. v0.3.9, PR/publication, and Harness timeout are still deferred.
...
- The compatibility target remains DSH Desktop v0.3.8. v0.3.9, Harness timeout changes, PR creation, and publication are deferred.
