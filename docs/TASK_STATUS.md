...
- Boundary: preserve timeout and cancellation behavior that belongs to Skill Manager itself, including GitHub requests, repository inspection, snapshot resolution, installation, and UI operations. Remove only cross-project Harness/shell investigation references.
- Acceptance: the public file tree contains no remaining references to the unrelated investigation; Skill Manager network/request timeout documentation remains intact; docs checks, focused repository search, Git diff checks, and GitHub CI pass before completion.
- Current status: completed. Removed the unrelated Scope block from README, deleted the dedicated overview subsection, and cleaned cross-project references from compatibility, environment, decision, context, and archived task records. Repository-wide targeted search returns no matches; Skill Manager's own bounded network, inspection, snapshot, and installation deadlines remain documented and unchanged.
...
- Scope: DSH Desktop v0.3.8 only. Do not install the isolated test Skill into the user's live registry, re-enable local provenance discovery, adapt v0.3.9, or publish from this historical iteration.
...
- Scope: DSH Desktop v0.3.8 only. No provenance re-enable, v0.3.9 adaptation, or PR/publication in this historical iteration.
...
- Scope: DSH Desktop v0.3.8 only. v0.3.9, PR/publication, fuzzy provenance, and execution of remote scripts were deferred.
...
- Deferred: v0.3.9, PR/publication, semantic/AI matching, and any relaxation of fixed-commit full-bundle provenance.
...
- Deferred: DSH Desktop v0.3.9, public PR/release, remote script execution, and unrelated UI redesign.
...
- Deferred: v0.3.9, PR/publication, central crawling, semantic/AI provenance, and remote script execution.
...
- Status: completed for DSH Desktop v0.3.8. No DSH/Electron process was running during replacement; the next normal v0.3.8 launch loads Protocol 5. v0.3.9, PR/publication, central indexing, and remote script execution remained deferred.
...
- Deferred: DSH Desktop v0.3.9, PR/publication, central GitHub crawling, semantic/AI source guessing, and execution of remote Skill scripts.
...
- Status: completed. DSH Desktop v0.3.9, PR/publication, and provenance-algorithm redesign remained outside this historical iteration.
...
- Status: completed. No DSH/Electron process was running after synchronization, so the next v0.3.8 launch loads this revision. v0.3.9, PR, publication, and destructive cleanup remained outside this historical iteration.
...
- Deferred: DSH Desktop v0.3.9, PR creation, publication, and a central historical Star index.
...
- Live Desktop/Harness installation is complete for the v0.3.8 evaluation directories. No GitHub push, PR, release, v0.3.9 adaptation, or central Indexer was part of this iteration.
